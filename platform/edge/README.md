...
- **Public Payment QR Activation (`/api/public/v1/payment-qr/activate`)**:
  - Sustained Rate Limit: `1 req/5s`, burst `2` (`CF-Connecting-IP`).
  - Tiered Rate Limiter: isolates boost triggers from general public REST endpoints.
...
- **Router Priorities**:
  ...
  - `1150`: Public Payment QR Activation Router (`acb-public-activation-router`)
