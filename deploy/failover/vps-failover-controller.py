...
DEFAULT_JOURNAL_PATH = Path("/opt/acb-transaction-webhook/data/deploy-journal.json")
...
def get_deployment_journal_path() -> Path:
    env_path = os.environ.get("ACB_TX_JOURNAL_FILE") or os.environ.get("TX_JOURNAL_FILE")
    if not env_path:
